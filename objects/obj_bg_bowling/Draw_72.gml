...
shader_set_uniform_f(u_pan,(x_ mod view_w)/view_w);
...
draw_sprite_pos(spr_bg_bowling_floor1,0,
	x_,wall_y, //top left
	x_+view_w,wall_y, //top right
	x_+view_w,view_h-16, //bottom right
	x_,view_h-16, //bottom left
1);
